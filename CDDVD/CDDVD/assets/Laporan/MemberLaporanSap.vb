...
Public Class MemberLaporanSap
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CDDVD.MemberLaporanSap.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMemberLaporanSap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MemberLaporanSap = New MemberLaporanSap()
        rpt.Site = Me.Site
        Return rpt
    End Function
