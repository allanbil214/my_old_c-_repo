...
Public Class KasetLaporanSap
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CDDVD.KasetLaporanSap.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKasetLaporanSap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KasetLaporanSap = New KasetLaporanSap()
        rpt.Site = Me.Site
        Return rpt
    End Function
