...
Public Class KaryawanLaporanSap
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CDDVD.KaryawanLaporanSap.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKaryawanLaporanSap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KaryawanLaporanSap = New KaryawanLaporanSap()
        rpt.Site = Me.Site
        Return rpt
    End Function
