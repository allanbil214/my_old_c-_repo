...
<Global.System.Data.Linq.Mapping.DatabaseAttribute(Name:="EsemkaBakery")>  _
Partial Public Class LinQDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.EsemkaBakery.My.MySettings.Default.EsemkaBakeryConnectionString, mappingSource)
		OnCreated
	End Sub
...
Partial Public Class Employee
	...
	Private _IncomingRawMaterialHeaders As EntitySet(Of IncomingRawMaterialHeader)
	...
	Public Sub New()
		...
		Me._IncomingRawMaterialHeaders = New EntitySet(Of IncomingRawMaterialHeader)(AddressOf Me.attach_IncomingRawMaterialHeaders, AddressOf Me.detach_IncomingRawMaterialHeaders)
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Employee_IncomingRawMaterialHeader", Storage:="_IncomingRawMaterialHeaders", ThisKey:="EmployeeId", OtherKey:="EmployeeId")>  _
	Public Property IncomingRawMaterialHeaders() As EntitySet(Of IncomingRawMaterialHeader)
		Get
			Return Me._IncomingRawMaterialHeaders
		End Get
		Set
			Me._IncomingRawMaterialHeaders.Assign(value)
		End Set
	End Property
	...
	Private Sub attach_IncomingRawMaterialHeaders(ByVal entity As IncomingRawMaterialHeader)
		Me.SendPropertyChanging
		entity.Employee = Me
	End Sub
	
	Private Sub detach_IncomingRawMaterialHeaders(ByVal entity As IncomingRawMaterialHeader)
		Me.SendPropertyChanging
		entity.Employee = Nothing
	End Sub
...
Partial Public Class IncomingRawMaterialDetail
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="RawMaterial_IncomingRawMaterialDetail", Storage:="_RawMaterial", ThisKey:="RawMaterialId", OtherKey:="RawMaterialId", IsForeignKey:=true)>  _
		...
		Set
			...
			If ((Object.Equals(previousValue, value) = false)  _
				...
				If ((previousValue Is Nothing)  _
					...
					previousValue.IncomingRawMaterialDetails.Remove(Me)
				End If
				Me._RawMaterial.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.IncomingRawMaterialDetails.Add(Me)
...
Partial Public Class IncomingRawMaterialHeader
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Employee_IncomingRawMaterialHeader", Storage:="_Employee", ThisKey:="EmployeeId", OtherKey:="EmployeeId", IsForeignKey:=true)>  _
	Public Property Employee() As Employee
		Get
			Return Me._Employee.Entity
		End Get
		Set
			...
			If ((Object.Equals(previousValue, value) = false)  _
				...
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._Employee.Entity = Nothing
					previousValue.IncomingRawMaterialHeaders.Remove(Me)
				End If
				Me._Employee.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.IncomingRawMaterialHeaders.Add(Me)
					Me._EmployeeId = value.EmployeeId
				Else
					Me._EmployeeId = CType(Nothing, Integer)
				End If
...
Partial Public Class RawMaterial
	...
	Private _IncomingRawMaterialDetails As EntitySet(Of IncomingRawMaterialDetail)
	...
	Public Sub New()
		MyBase.New
		Me._IncomingRawMaterialDetails = New EntitySet(Of IncomingRawMaterialDetail)(AddressOf Me.attach_IncomingRawMaterialDetails, AddressOf Me.detach_IncomingRawMaterialDetails)
		Me._RawMaterialIntakes = New EntitySet(Of RawMaterialIntake)(AddressOf Me.attach_RawMaterialIntakes, AddressOf Me.detach_RawMaterialIntakes)
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="RawMaterial_IncomingRawMaterialDetail", Storage:="_IncomingRawMaterialDetails", ThisKey:="RawMaterialId", OtherKey:="RawMaterialId")>  _
	Public Property IncomingRawMaterialDetails() As EntitySet(Of IncomingRawMaterialDetail)
		Get
			Return Me._IncomingRawMaterialDetails
		End Get
		Set
			Me._IncomingRawMaterialDetails.Assign(value)
		End Set
	End Property
	...
	Private Sub attach_IncomingRawMaterialDetails(ByVal entity As IncomingRawMaterialDetail)
		Me.SendPropertyChanging
		entity.RawMaterial = Me
	End Sub
	
	Private Sub detach_IncomingRawMaterialDetails(ByVal entity As IncomingRawMaterialDetail)
		Me.SendPropertyChanging
