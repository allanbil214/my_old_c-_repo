...
Partial Class ViewIncomingRawMaterialForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "Incoming Raw Material Header :"
        '
        'Label1
        '
        ...
        Me.Label1.Text = "Esemka Bakery : View Incoming Raw Material "
        '
        'DataGridView2
        '
        ...
        Me.Label3.Text = "Incoming Raw Material Detail :"
        '
        'ViewIncomingRawMaterialForm
        '
        ...
        Me.Name = "ViewIncomingRawMaterialForm"
